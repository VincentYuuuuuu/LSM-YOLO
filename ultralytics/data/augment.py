...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            check_version(A.__version__, '1.3.1', hard=True)  # version requirement

            T = [
                A.augmentations.geometric.transforms.GridDistortion(p=0.01),
                A.augmentations.geometric.transforms.ElasticTransform(p=0.01)]  # transforms
